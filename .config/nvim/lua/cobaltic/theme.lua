...
local italic = vim.g.italic == false and cobaltic.none or "italic"
local italic_undercurl = vim.g.italic == false and "undercurl" or "italic,undercurl"
local bold = vim.g.bold == false and cobaltic.none or "bold"
local reverse_bold = vim.g.bold == false and "reverse" or "reverse,bold"
local bold_underline = vim.g.bold == false and "underline" or "bold,underline"
local bold_italic
if vim.g.bold == false then
    bold_italic = vim.g.italic == false and cobaltic.none or "italic"
elseif vim.g.italic == false then
    bold_italic = "bold"
else
...
theme.loadSyntax = function()
    ...
    return {
        ...
        Comment = { fg = cobaltic.dark_green, style = italic }, -- italic comments
...
theme.loadEditor = function()
    ...
    local editor = {
        ...
        BufferInactive = { bg = cobaltic.background, fg = cobaltic.dark_green },
        BufferInactiveMod = { bg = cobaltic.background, fg = cobaltic.bright_magenta },
        BufferInactiveIcon = { bg = cobaltic.background, fg = cobaltic.dark_green },
        BufferInactiveSign = { bg = cobaltic.background, fg = cobaltic.dark_green },
        BufferInactiveIndex = { bg = cobaltic.background, fg = cobaltic.dark_green },
        ...
        -- nvim-notify
        NotifyDEBUGBorder = { fg = cobaltic.dark_green },
        NotifyDEBUGIcon = { fg = cobaltic.dark_green },
        NotifyDEBUGTitle = { fg = cobaltic.dark_green },
    ...
    if vim.g.uniform_diff_background then
...
theme.loadTerminal = function()
    ...
    vim.g.terminal_color_8 = cobaltic.dark_green
...
theme.loadTreeSitter = function()
    ...
    local treesitter = {
        ...
        TSText = { fg = cobaltic.foreground }, -- For strings considecobaltic11_gui text in a markup language.
    ...
    treesitter.TSComment = { fg = cobaltic.dark_green, style = italic } -- comments
    ...
    treesitter["@comment"] = { fg = cobaltic.dark_green, style = italic }
...
theme.loadPlugins = function()
    ...
    local plugins = {
        ...
        diffLine = { fg = cobaltic.dark_green },
        ...
        GitSignsCurrentLineBlame = { fg = cobaltic.dark_green, style = bold },
        ...
        NvimTreeGitIgnored = { fg = cobaltic.dark_green },
        ...
        FinderVirtText = { fg = cobaltic.cobaltic15_gui15, bg = cobaltic.none },
        ...
        -- Indent Blankline
        IndentBlanklineChar = { fg = cobaltic.dark_green },
        ...
        -- Illuminate
        illuminatedWord = { bg = cobaltic.dark_green },
        illuminatedCurWord = { bg = cobaltic.dark_green },
        IlluminatedWordText = { bg = cobaltic.dark_green },
        IlluminatedWordRead = { bg = cobaltic.dark_green },
        IlluminatedWordWrite = { bg = cobaltic.dark_green },
        ...
        HopUnmatched = { fg = cobaltic.dark_green },

        -- Fern
        FernBranchText = { fg = cobaltic.dark_green },
        ...
        LightspeedGreyWash = { fg = cobaltic.dark_green },
        ...
        -- copilot
        CopilotLabel = { fg = cobaltic.dark_green, bg = cobaltic.none },

        -- Statusline
        StatusLineDull = { fg = cobaltic.dark_green, bg = cobaltic.dark_black },
        StatusLineAccent = { fg = cobaltic.background, bg = cobaltic.bright_yellow },

        -- mini.nvim
        MiniCompletionActiveParameter = { style = "underline" },

        MiniCursorword = { bg = cobaltic.dark_green },
        MiniCursorwordCurrent = { bg = cobaltic.dark_green },
        ...
        MiniTablineHidden = { bg = cobaltic.background, fg = cobaltic.dark_green },
        ...
        AerialFieldIcon = vim.g.italic and { fg = cobaltic.foreground, style = italic }
            or { fg = cobaltic.foreground },
        AerialFileIcon = { fg = cobaltic.bright_green },
        AerialFunctionIcon = vim.g.italic and { fg = cobaltic.dark_yellow, style = italic }
            or { fg = cobaltic.dark_yellow },
        AerialInterfaceIcon = { fg = cobaltic.dark_magenta },
        AerialKeyIcon = { fg = cobaltic.dark_magenta },
        AerialMethodIcon = vim.g.italic and { fg = cobaltic.dark_cyan, style = italic }
            or { fg = cobaltic.dark_cyan },
        AerialModuleIcon = vim.g.italic and { fg = cobaltic.foreground, style = italic }
            or { fg = cobaltic.foreground },
        AerialNamespaceIcon = vim.g.italic and { fg = cobaltic.foreground, style = italic }
            or { fg = cobaltic.foreground },
        ...
        AerialPackageIcon = vim.g.italic and { fg = cobaltic.foreground, style = italic }
            or { fg = cobaltic.foreground },
        AerialPropertyIcon = vim.g.italic and { fg = cobaltic.foreground, style = italic }
            or { fg = cobaltic.dark_blue },
        AerialStringIcon = vim.g.italic and { fg = cobaltic.bright_green, style = italic }
            or { fg = cobaltic.bright_green },
        ...
        AerialField = vim.g.italic and { fg = cobaltic.foreground, style = italic }
            or { fg = cobaltic.foreground },
        AerialFile = { fg = cobaltic.bright_green },
        AerialFunction = vim.g.italic and { fg = cobaltic.dark_yellow, style = italic }
            or { fg = cobaltic.dark_yellow },
        AerialInterface = { fg = cobaltic.dark_magenta },
        AerialKey = { fg = cobaltic.dark_magenta },
        AerialMethod = vim.g.italic and { fg = cobaltic.dark_cyan, style = italic } or { fg = cobaltic.dark_cyan },
        AerialModule = vim.g.italic and { fg = cobaltic.foreground, style = italic }
            or { fg = cobaltic.foreground },
        AerialNamespace = vim.g.italic and { fg = cobaltic.foreground, style = italic }
            or { fg = cobaltic.foreground },
        ...
        AerialPackage = vim.g.italic and { fg = cobaltic.foreground, style = italic }
            or { fg = cobaltic.foreground },
        AerialProperty = vim.g.italic and { fg = cobaltic.foreground, style = italic }
            or { fg = cobaltic.dark_blue },
        AerialString = vim.g.italic and { fg = cobaltic.bright_green, style = italic }
            or { fg = cobaltic.bright_green },
